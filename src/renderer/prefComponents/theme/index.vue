<template>
  <div class="pref-theme">
    <h4>{{ $t('file.preferences.theme.root') }}</h4>
    ...
    <separator></separator>
    <cur-select
      :description="$t('file.preferences.theme.description')"
    ...
    <section v-show="false" class="import-themes ag-underdevelop">
      <div>
        <span>{{ $t('file.preferences.theme.floder') }}</span>
        <el-button size="small">{{ $t('file.preferences.theme.floderButton') }}</el-button>
      </div>

      <div>
        <span>{{ $t('file.preferences.theme.import') }}</span>
        <el-button size="small">{{ $t('file.preferences.theme.importButton') }}</el-button>
      </div>
    </section>
  </div>
</template>
